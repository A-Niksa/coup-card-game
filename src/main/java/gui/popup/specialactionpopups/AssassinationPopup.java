...
public class AssassinationPopup extends SpecialActionPopupTemplate {
    private ArrayList<Player> alivePlayersList;
    private ArrayList<JRadioButton> playersRadioButtonsList;

    public AssassinationPopup(PopupFrame frame, PopupTemplate previousPopupPanel, ActionsStack stack) {
    ...
    protected void connectListeners() {
        confirmButton.addActionListener(e -> {
            ...
            SpecialActionsUtils.assassinate(frame, this, targetName);
        });
    }
}