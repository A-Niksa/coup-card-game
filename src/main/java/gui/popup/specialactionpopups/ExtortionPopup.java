...
public class ExtortionPopup extends SpecialActionPopupTemplate {
    private ArrayList<Player> alivePlayersList;
    private ArrayList<JRadioButton> playersRadioButtonsList;

    public ExtortionPopup(PopupFrame frame, PopupTemplate previousPopupPanel, ActionsStack stack) {
    ...
    protected void connectListeners() {
        confirmButton.addActionListener(e -> {
            ...
            SpecialActionsUtils.extort(this, targetName);
        });
    }
}